...
beautiful.init("/home/saurabh/.config/awesome/default/theme.lua")
...
mymainmenu = awful.menu({ items = { { "apps", function() awful.spawn('/home/saurabh/.config/rofi/launchers/misc/launcher.sh') end},
...
--    awful.key({ modkey,           }, "w", function () mymainmenu:show() end,
 --             {description = "show main menu", group = "awesome"}),
    ...
    awful.key({},     'XF86AudioNext',		    function()  awful.spawn('playerctl next')    	    end,
    	      {description = 'toggle next', group = 'Keys'}),
    awful.key({},     'XF86AudioPlay',              function()	awful.spawn('playerctl play-pause')	    end,
	      {description = 'toggle previous', group = 'Keys'}),
    awful.key({modkey, "Shift" },     'b',              function()	awful.spawn('btmenu')	    end,
	      {description = 'toggle previous', group = 'Keys'}),
    awful.key({},     'XF86PowerOff',              function()	awful.spawn('exitx')	    end,
	      {description = 'powermenu', group = 'Keys'})
...
autorunApps =
{
   ...
   "xfce4-power-manager",
   "blueberry-tray",
   "/home/saurabh/.config/awesome/awspawn",
